...
import root.intelligentasteroidsshooter.IntelligentAsteroidsShooter;
import root.intelligentasteroidsshooter.StartViewController;
...
public class RestartViewController {
    ...
    protected void fillTable(List<String> list, String newRecordHolder){
       ...
       .toList();
        ...
        column1.getStyleClass().add("root/intelligentasteroidsshooter/static/customStyles.css");
